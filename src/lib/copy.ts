...
> = {
  S1: {
    ...
    description:
      'Clear, structured, hands-on instruction — you tell people what to do, how to do it, and when it\'s due. New team members know exactly where they stand.',
    strength:
      'You give people total clarity. No one on your team wonders what\'s expected of them, especially when they\'re new to a task.',
    blindSpot:
      'You\'re light on two-way dialogue and emotional support. With people who have the skill but need confidence — not more instruction — this can feel like you don\'t quite trust them yet.',
    developmentFocus:
  ...
  S2: {
    ...
    description:
      'High direction paired with high support — you explain your reasoning, invite questions, and build skill and confidence at the same time. The rarest leadership mode.',
    strength:
    ...
    developmentFocus:
      'Develop your ability to let go cleanly. When someone has demonstrated both skill and confidence, the most developmental thing you can do is give them real ownership — not more dialogue.',
  },
  S3: {
    name: 'Supporting',
    tagline: 'You give people permission to trust themselves.',
    description:
      'Low direction, high support — you step back from telling people how to do the work, but stay close: encouraging, listening, building confidence in those who already have the skill.',
    strength:
  ...
  S4: {
    ...
    description:
      'Low direction, low support — you hand off real ownership and trust people to run with it, stepping in only when asked. Your strongest people get to do their best work.',
    strength:
